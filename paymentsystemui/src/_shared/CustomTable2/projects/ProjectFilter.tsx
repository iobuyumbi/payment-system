...
const ProjectFilter = () => {
  ...
  const getCountriesList = async () => {
    ...
    const countriesData=await countryService.getCountryData(1);
    if(countries){
    ...
    <>
      ...
      <div className='menu menu-sub menu-sub-dropdown w-300px w-md-325px' data-kt-menu='true'>
        ...
        <div className='px-7 py-5' data-kt-user-table-filter='form'>
          ...
          {countries&& countries.map((item: any, id:number) => (
          ...
          <div className='d-flex justify-content-end'>
            <button
              ...
              disabled={isLoading}
              onClick={filterData}
              className='btn btn-light btn-active-light fw-bold me-2 px-6'
            ...
            <button
              ...
              type='button'
              onClick={resetData}
              className='btn btn-theme fw-bold px-6'
              data-kt-menu-dismiss='true'
