...
import GlobalLoanPortfolioReport from "./partials/GlobalLoanPortfolioReport";
  ...
  return (
    <>
      ...
      <div className="container my-4">
        ...
        <Card className="mb-3">
          <Card.Body>
            <h5>Global Loan Portfolio Reports</h5>
           
            <GlobalLoanPortfolioReport title={""} reportData={[]} />
          </Card.Body>
        </Card>
      </div>
    </>
...
export default GlobalPortfolioSummary;
