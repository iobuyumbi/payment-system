...
const CountryLoanPortfolioSummary = () => {
    ...
    <>
      ...
      <div className="container my-4">
        ...
        <PageTitle breadcrumbs={profileBreadCrumbs}>
          Country Loan Portfolio Reports{" "}
        </PageTitle>
        ...
        <Card className="mb-3">
          <Card.Body>
            <h5>Country Loan Portfolio Reports</h5>
           
            <CountryLoanPortfolioReport title={""} reportData={[]} />
          </Card.Body>
        </Card>
      </div>
    </>
...
export default CountryLoanPortfolioSummary;
