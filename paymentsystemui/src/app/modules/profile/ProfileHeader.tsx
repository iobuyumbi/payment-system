              ...
              <ul className='nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap'>
                <li className='nav-item'>
                  <Link
                    className={
                      ...
                      (location.pathname === '/user/profile/overview' && 'active')
                    }
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === '/user/profile/projects' && 'active')
                    }
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === '/user/profile/campaigns' && 'active')
                    }
                    to='/user/profile/campaigns'
                  >
                    Campaigns
                  </Link>
                </li>
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === '/user/profile/documents' && 'active')
                    }
                ...
                <li className='nav-item'>
                  <Link
                    className={
                      `nav-link text-active-primary me-6 ` +
                      (location.pathname === '/user/profile/connections' && 'active')
                    }
