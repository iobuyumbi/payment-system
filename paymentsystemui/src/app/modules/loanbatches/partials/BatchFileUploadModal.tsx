...
import UploadBatchFiles from "./UploadBatchFiles";

export default function BatchFileUploadModal(props: any) {
    const {  afterConfirm, isAdd } = props;
    const loanApplication: any = useSelector(
        (state: any) => state?.loanApplications
      );
    const [title] = useState<any>( "Upload" );
    return (
        <>
                    ...
                    <div className='modal-content'>
                        <div className='modal-header'>
                            <div className="w-100 d-flex flex-row align-items-center justify-content-between">
                                {/* begin::Modal title */}
                                <div>
                                    <h2 className='fw-semibold'>{title} Loan Product Files</h2>
                                </div>
                                {/* end::Modal title */}
