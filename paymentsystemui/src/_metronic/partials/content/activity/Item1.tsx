      ...
      <div className='timeline-content mb-10 mt-n1'>
        <div className='pe-3 mb-5'>
          <div className='fs-5 fw-normal mb-2'>
            There are 2 loans associated with this account:
          </div>
          ...
          <div className='d-flex align-items-center mt-1 fs-6'>
            ...
            {/* <div
              ...
              title='Nina Nilson'
            >
              <img src={toAbsoluteUrl('media/avatars/blank.png')} alt='img' />
            </div> */}
          </div>
        </div>
        ...
        <div className='overflow-auto pb-5'>
          <div className='d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5'>
            ...
            <div className='min-w-175px pe-2'>
              <span className='badge badge-light text-muted'>Seedlings</span>
            </div>
          ...
          <div className='d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0'>
            ...
            <div className='min-w-175px'>
              <span className='badge badge-light text-muted'>Machinery</span>
            </div>
            ...
            <div className='min-w-125px'>
              <span className='badge badge-light-success'>Closed</span>
            </div>
