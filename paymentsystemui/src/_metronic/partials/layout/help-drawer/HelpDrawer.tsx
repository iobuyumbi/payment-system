          ...
          >
            ...
            <div className='rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10'>
              ...
              <h2 className='fw-bolder mb-5'>
                Support at{' '}
                <a href='https://devs.solidaridadnetwork.org' className=''>
                  devs.solidaridadnetwork.org
                </a>
              </h2>
              {/* end::Heading */}
              ...
              <div className='fs-5 fw-bold mb-5'>
                ...
                <a className='explore-link d-none' href='https://www.solidaridadnetwork.org/licensing'>
                  FAQs
                </a>
              </div>
              {/* end::Description */}
              ...
              {/* begin::Link */}
              <a
                href='https://devs.solidaridadnetwork.org'
            ...
            <div className='d-flex align-items-center mb-7'>
              ...
              <div className='d-flex flex-stack flex-grow-1 ms-4 ms-lg-6'>
                ...
                <div className='d-flex flex-column me-2 me-lg-5'>
                  {/* begin::Title */}
                  <a
                    href='https://preview.solidaridadnetwork.org/metronic8/react/docs/quick-start'
            ...
            <div className='d-flex align-items-center mb-7'>
              ...
              <div className='d-flex flex-stack flex-grow-1 ms-4 ms-lg-6'>
                ...
                <div className='d-flex flex-column me-2 me-lg-5'>
                  {/* begin::Title */}
                  <a
                    href='https://preview.solidaridadnetwork.org/metronic8/react/docs/utilities'
                    className='text-gray-900 text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1'
                  >
                    Plugins &amp; Components
                  </a>
            ...
            <div className='d-flex align-items-center mb-7'>
              ...
              <div className='d-flex flex-stack flex-grow-1 ms-4 ms-lg-6'>
                ...
                <div className='d-flex flex-column me-2 me-lg-5'>
                  {/* begin::Title */}
                  <a
                    href='https://preview.solidaridadnetwork.org/metronic8/react/docs/changelog'
                    className='text-gray-900 text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1'
                  >
                    What's New
                  </a>
