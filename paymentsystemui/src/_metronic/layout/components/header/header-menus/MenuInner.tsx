      ...
      >
        ...
        >
          <MenuInnerWithSub
            ...
            menuTrigger={`{default:'click', lg: 'hover'}`}
          >
            <MenuItem to='/user/profile/overview' title='Overview' hasBullet={true} />
            <MenuItem to='/user/profile/projects' title='Projects' hasBullet={true} />
            <MenuItem to='/user/profile/campaigns' title='Campaigns' hasBullet={true} />
            <MenuItem to='/user/profile/documents' title='Documents' hasBullet={true} />
            <MenuItem
        ...
        <MenuInnerWithSub
          ...
          menuTrigger={`{default:'click', lg: 'hover'}`}
        >
          <MenuItem to='/user/account/overview' title='Overview' hasBullet={true} />
          <MenuItem to='/user/account/settings' title='Settings' hasBullet={true} />
        </MenuInnerWithSub>
